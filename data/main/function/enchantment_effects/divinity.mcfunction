...
execute if entity @s[predicate=main:armour_enchants/divinity_chestplate] run scoreboard players add @s divinity 1
execute if entity @s[predicate=main:armour_enchants/divinity_leggings] run scoreboard players add @s divinity 1
execute if entity @s[predicate=main:armour_enchants/divinity_helmet] run scoreboard players add @s divinity 1
execute if entity @s[predicate=main:armour_enchants/divinity_boots] run scoreboard players add @s divinity 1
execute if entity @s[predicate=main:armour_enchants/divinity_mainhand] run scoreboard players add @s divinity 1
